document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadFiles() {
        ...
        try {
            ...
            if (data.length === 0) {
                fileList.innerHTML = '<li style="justify-content: center; color: var(--text-secondary);">Vault is currently empty</li>';
                return;
            }
            ...
            data.forEach(file => {
                ...
                li.innerHTML = `
                    ...
                    <a href="/download/${file.id}" class="download-btn" title="Download Token">
            ...
            fileList.innerHTML = '<li style="color: var(--error);">Error fetching files</li>';
        }
    }
});
